...
1. [ ] Create a GET REST api on the episode enitity in the python codebase. API /episodes/ can list all episodes. API /episodes/{id} lists details of episode witd id {id}
2. [ ] set up vite server
3. [ ] create all episodes web page running on vite server using tailwind shadcn ui react that queries GET REST api on the episode enitity
