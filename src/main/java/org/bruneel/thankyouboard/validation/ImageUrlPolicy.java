...
public final class ImageUrlPolicy {
    ...
    public static final String DEFAULT_ALLOWED_HOSTS =
    ...
    public static ImageUrlPolicy fromCsv(String csv) {
    ...
    public String normalizeAndValidateHttpsUrl(String rawUrl) {
    ...
    public String normalizeAndValidateHttpOrHttpsUrl(String rawUrl) {
        String trimmed = rawUrl == null ? "" : rawUrl.trim();
        if (trimmed.isBlank()) {
            return null;
        }
    ...
    public boolean isAllowedHttpUrl(String rawUrl) {
        String trimmed = rawUrl == null ? "" : rawUrl.trim();
        if (trimmed.isBlank()) {
            return false;
        }
